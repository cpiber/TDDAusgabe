...
const karte_designs_help = `
  ...
  <li><span class="code">$Ort</span>: Ort-ID</li>
  <li><span class="code">$Ortname</span></li>
  <li><span class="code">$Num</span></li>
  ...
  <li><span class="code">$ProfilBild1</span>: Bildelement</li>
  <li><span class="code">$ProfilBild2</span>: Bild Link</li>
  <li><span class="code">$ProfilBildSrc1</span>: Bildelement</li>
  <li><span class="code">$ProfilBildSrc2</span>: Bild Link</li>
